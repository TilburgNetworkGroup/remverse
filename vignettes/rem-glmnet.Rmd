...
- **Bayesian** (`approach = "Bayesian"`): shrinkage priors (default horseshoe) via `shrinkem`. This tends to be fast and to produce a parsimonious set of non-zero effects, and is our recommended route for penalized REMs.
...
```{r glmnet-default, message=FALSE}
