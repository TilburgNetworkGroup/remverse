...
Note that moving-window estimation is not fully model and thus not a substitute for a fully specified time-varying-coefficient model. Each window is an independent fit on a subset of events.
